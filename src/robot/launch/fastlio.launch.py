...
def generate_launch_description():
    ...
    # Package/executable names differ across ROS2 FAST-LIO forks.
    # Defaults are common, but can be overridden from the command line.
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "start_fast_lio",
            default_value="false",
            description="Set true after installing a ROS2 FAST-LIO package.",
        ),
        ...
        gazebo,
        LogInfo(msg="FAST-LIO uses adapted cloud /points/fast_lio and IMU /imu."),
        LogInfo(msg="Install FAST-LIO, then relaunch with start_fast_lio:=true and package/executable args if needed."),
